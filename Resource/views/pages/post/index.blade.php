            ...
            <div class="w-100 p-shadow bg-white showcart py-9 mt-6 px-4">
                        ...
                        <table class="address table table-bordered mt-3">
                            ...
                            <tr>
                                <td class="address-item text-center align-middle" rowspan="3">
                                    ...
                                    <input class="address-radio" name="address" type="radio" value="{{$row->id}}">
                                </td>
                ...
                <div class="mt-7 px-0 px-lg-8 table-responsive">
                    ...
                    @foreach($posts as $post)
                        <div class="mt-5 border border-1 border-silver rounded-2 w-100 d-flex justify-content-between align-items-center"
                             style="height: 12rem;">
                            <div class="width-3 flex-center h-100 border-start border-1 border-gray"
                                 onclick="selectShipping(this)">
                <span class="border border-1 border-gray rounded-circle d-flex position-relative"
                      style="width: 3rem; height: 3rem;">
                  <span class="checkmark d-none"
                        style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: green; border-radius: 50%;"></span>
                </span>
                                <input type="radio" value="{{$post->id}}" name="shipping" class="d-none">
                            </div>
                ...
                <div class="w-100 flex-between mt-4 px-0 px-lg-8">
                    ...
                    <a id="continue-order" class="showcart-btn bg-success gap-2">
...
@push('script')
    ...
    <script src="{{URL}}assets/js/postValidate.js"></script>
