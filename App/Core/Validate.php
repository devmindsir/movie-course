...
class Validate
{
  ...
  public static function validateFullName($name)
  {
    ...
    self::validateUserNameRegex('name', $name);
  }
  ...
  public static function validateRegex($fieldName, $value)
  {
    ...
    public static function validateUserNameRegex($fieldName, $value)
    {
        if (!preg_match('/^[\p{Arabic}\s]+$/u', $value)) {
            self::$errors[$fieldName] = 'باید فقط شامل حروف فارسی و فاصله باشد';
        }
    }
